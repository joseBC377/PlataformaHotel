...
public class UsuarioRestController {
    ...
    public Usuario selectIdUser(@PathVariable("id") Integer id) {
    ...
    public Usuario updateIdUser(@PathVariable("id") Integer id,@Valid @RequestBody Usuario usuario) {
        usuario.setId_usuario(id); //asi haga lo que haga tendra el mismo id
        return service.updateUsuario(id, usuario);
    }

    @DeleteMapping(value = "/eliminar/{id}")
    public void deleteIdUser(@PathVariable("id") Integer id) {
